...
values
  ...
  ('web-1', 'web', 'Sua primeira página HTML', 1, 'Conheça a estrutura que organiza o conteúdo de uma página.', 'HTML descreve a estrutura da página. Títulos, parágrafos e links usam elementos semânticos que também melhoram a acessibilidade.', 'O que o HTML descreve?', 'A estrutura da página', '["A velocidade da internet","A estrutura da página","A senha do usuário"]', true),
  ('curriculo-1', 'curriculo', 'Informações essenciais', 1, 'Selecione as informações que ajudam recrutadores a conhecer você.', 'Um currículo claro traz contato, objetivo, formação, experiências e habilidades relevantes. Evite documentos e outros dados desnecessários.', 'Qual dado deve ser evitado no currículo?', 'Número de documento', '["Formação","Número de documento","Habilidades"]', true),
